export const resources = {
  en: {
    translation: {
      ...
      skillsEmptyHint: 'Add a skill manually or explore the catalog to get started.',
      discoveredHint: 'Review discovered skills to import them.',
      toolsLabel: 'Tools',
  ...
  zh: {
    translation: {
      ...
      skillsEmpty: '暂无托管记录。',
      skillsEmptyHint: '手动添加技能或探索目录以开始使用。',
      discoveredHint: '查看已发现的 Skills 进行导入。',
      toolsLabel: '工具',
      activeTools: '活跃工具',
      sourceLabel: '来源',
      pathLabel: '路径',
